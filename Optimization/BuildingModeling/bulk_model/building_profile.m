...
Damper = 1;
Tsupply = nan;
Cp_amb = 1.006 + 1.86*psychometric('Tdb',Tdb,'RH',RH,'w'); % kJ/kg*K
Cp_build = 1.006 + 1.86*psychometric('Tdp',Tdb,'w'); %kJ/kg
...
m_v_air = psychometric('Tdb',Tdb,'RH',RH,'w');
Cp_amb = 1.006 + 1.86*m_v_air; % kJ/kg*K
m_v_set = psychometric('Tdp',Tdb,'w');
